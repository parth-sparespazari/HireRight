...
export default function Footer() {
    return (
        <footer className="pt-20 pb-10 px-20 font-hanken bg-[#101316]">
            <div className="flex flex-col gap-y-15">
                ...
                <div className="flex flex-wrap justify-between gap-25">
                    <div className="flex flex-col gap-5">
                        <h4 className="font-semibold text-base leading-[110%] tracking-normal align-middle text-[#FAFAFACC]">About</h4>
