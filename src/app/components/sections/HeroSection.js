        ...
        <section className="pt-30 pb-40 font-hanken bg-gradient-to-b from-white from-[0%] via-white via-[80%] to-[#FFF8E8] to-[80%]">
            <div className="container mx-auto px-4 flex flex-col items-center gap-y-0 ">
                ...
                <div className="flex flex-row items-center gap-5 mt-10">
                    <Link href="/plans" className="rounded-xl px-5 py-3 text-md font-medium transition bg-indigo-500 text-white hover:bg-indigo-400">
                        Watch Demo
                    </Link>
                    <Link href="/pricing" className="rounded-xl px-5 py-3 text-md font-medium transition border-1 border-zinc-400 hover:bg-zinc-100">
                        View Pricing
                    </Link>
                </div>
                <div className="flex flex-row items-center gap-5 mt-15">
                    ...
                    <a href="">
                        <img src="/icons/Linkedin-vector.svg" alt="LinkedIn" />
                    </a>
                </div>
                <Image
