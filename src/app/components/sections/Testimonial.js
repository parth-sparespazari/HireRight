...
export default function Testimonial() {
    return (
        <section className="relative py-15 md:py-20 xl:py-30 font-hanken">
            ...
            <div className="relative z-10 container mx-auto px-5 flex flex-col items-center gap-y-5">
            ...
            <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory md:hidden">
                ...
                <div className="min-w-[85%] max-w-[400px] snap-start">
                    <div className="w-full rounded-[20px] gap-6 border border-[#58240E3D] flex flex-col bg-[#fffbf8] py-5 px-8">
                        <p className="font-medium text-md leading-[120%] tracking-[-0.1px] align-middle">Lorem ipsum dolor sit amet consectetur. Pulvinar eget et in gravida mi. A ullamcorper pulvinar scelerisque egestas leo mauris cras ornare.</p>
                        <div className="flex gap-3 items-center">
                ...
                <div className="min-w-[85%] max-w-[400px] snap-start">
                    <div className="w-full rounded-[20px] gap-6 border-1 border-[#58240E3D] flex flex-col bg-[#fffbf8] py-5 px-8 md:mt-10">
                        <p className="font-medium text-md leading-[120%] tracking-[-0.1px] align-middle">Lorem ipsum dolor sit amet consectetur. Pulvinar eget et in gravida mi. A ullamcorper pulvinar scelerisque egestas leo mauris cras ornare.</p>
                        <div className="flex gap-3 items-center">
                            <div className="w-12 h-12 border-1 border-[#58240E3D] rounded-full bg-white"></div>
                            <div className="flex flex-col gap-1 grow">
                ...
                <div className="min-w-[85%] max-w-[400px] snap-start">
                    <div className="w-full rounded-[20px] gap-6 border-1 border-[#58240E3D] flex flex-col bg-[#fffbf8] py-5 px-8">
                        <p className="font-medium text-md leading-[120%] tracking-[-0.1px] align-middle">Lorem ipsum dolor sit amet consectetur. Pulvinar eget et in gravida mi. A ullamcorper pulvinar scelerisque egestas leo mauris cras ornare.</p>
                        <div className="flex gap-3 items-center">
                            <div className="w-12 h-12 border-1 border-[#58240E3D] rounded-full bg-white"></div>
                            <div className="flex flex-col gap-1 grow">
