...
export default function HireTalents() {
    return (
        <section className="py-15 md:py-20 xl:py-30 font-hanken bg-gradient-to-b from-[#FFF8E8] to-white">
            <div className="container mx-auto px-4 flex flex-col gap-y-10 xl:gap-y-15">
                <div className="flex flex-col gap-y-5">
                    ...
                    <p className="font-normal text-[14px] md:text-[18px] xl:text-[24px] leading-[110%] xl:leading-[116%] tracking-[-0.02em] text-[#231A16A3]">Transform your recruitment with AI companions that conduct natural, <br /> mentor-like interviews while giving you complete cost control.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-center">
                    <div className="flex flex-col gap-y-7 md:gap-y-10 md:col-span-2">
