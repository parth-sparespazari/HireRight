    ...
    return (
        <section className="py-30 font-hanken relative z-1">
            <div className="container mx-auto flex flex-col items-center gap-y-5">
                ...
                <Link href="/plans" className="rounded-full px-6 py-4 mt-7 text-md font-medium transition-all duration-300 ease-in-out bg-[#6567e2] text-white hover:bg-[#7173e4] active:rounded-[0.7em]">
                    Explore plans
                </Link>
            </div>
        </section>
